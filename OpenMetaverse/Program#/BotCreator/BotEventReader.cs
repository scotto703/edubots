...
//
// Edited: Lawrence Miller - updated loadbotmovement to handle
//         bot turning towards object. Used for positionBot method
//         method in BotLoad.cs
//***************************************************************
using System;
...
namespace BotGUI
{
    class BotEventReader
    {
            ...
            while (reader.Read() && !endOfMethod)
            {
                switch (reader.NodeType)
                {
                    ...
                    case XmlNodeType.Element:
                        ...
                        //make bot turn towards object
                        else if (reader.Name == "turnToward")
                        {
                            botMovement.turnToward(readVectorCoord(reader));
                        }
                        break;
                    case XmlNodeType.EndElement:
        ...
        private void loadLoop(XmlTextReader reader)
        {
        }
